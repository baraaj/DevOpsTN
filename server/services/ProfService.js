...
profService.ajouter = (prof) => {
    return new Promise((reslove,reject) => {
        ...
        db.query(`INSERT INTO profs(nom,prenom,email,password,cni,specialite,date_embauche) VALUES('${nom}','${prenom}','${email}','${password}','${cni}','${specialite}','${date_embauche}')`,(err,result) => {
            let res = {};
            if(err) 
            // res.error = err;
            throw err;
