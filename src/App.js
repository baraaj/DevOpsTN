...
import ListCard from './compenents/cours/ListCard';
    ...
    return (
      ...
      <div className="App">
        ...
        <Navbar email={this.emailchange} nom={this.nomchange} prenom={this.prenomchange} 
                ...
                cni={this.cinchange} specialite={this.specialitechange} niveau={this.niveauchange} 
                date={this.datechange} cours={this.compenentcourschange} 
                exercice={this.compenentexercicechange} 
...
/*****************************************************recherche exercices ************************************* */
  ...
  cinchange = (e)=>{
    this.setState({cni:e.target.value});
  }
  specialitechange = (e)=>{
